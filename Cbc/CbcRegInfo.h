...
namespace Cbc{
	...
	class CbcRegItem{
		...
		public:
			CbcRegItem():fFeId(0), fCbcId(0), fName(),fDefVal(0),fValue0(0), fValue(0), fWriteFailed(0){}
			CbcRegItem( UInt_t pFeId, UInt_t pCbcId, const char *pName, UInt_t pPage, UInt_t pAddr, UInt_t pDefVal, UInt_t pValue0, Bool_t pWriteFailed=0 ): 
				fFeId(pFeId), fCbcId(pCbcId), fName(pName), fPage(pPage), fAddress(pAddr), fDefVal(pDefVal), fValue0(pValue0), fValue(0), fWriteFailed(pWriteFailed){}
			~CbcRegItem(){}
		...
		private:
			...
			UInt_t fDefVal;
			UInt_t fValue0;     
			UInt_t fValue;         //Read register value
	...
	class CbcRegList: public std::vector<CbcRegItem *>{
		...
		UInt_t GetValue( UInt_t pPage, UInt_t pAddr )const;
		UInt_t GetValue( const std::string &pName )const;
		...
		void SetValue0( UInt_t pPage, UInt_t pAddr, UInt_t pValue );
		void SetValue0( const std::string &pName, UInt_t pValue );
		void SetValue( UInt_t pPage, UInt_t pAddr, UInt_t pValue );
		void SetValue( const std::string &pName, UInt_t pValue );
	...
	class FeCbcRegMap: public std::map<UInt_t, CbcRegList>{ 
		...
		UInt_t GetValue( UInt_t pCbc, UInt_t pPage, UInt_t pAddr )const;
		UInt_t GetValue( UInt_t pCbc, const std::string &pName )const;

		void Clear();
		void AddCbc( UInt_t pCbc, CbcRegList pCC=CbcRegList() ); 
		void AddItem( UInt_t pCbc, CbcRegItem *pItem ); 
		void SetValue0( UInt_t pCbc, UInt_t pPage, UInt_t pAddr, UInt_t pValue );
		void SetValue0( UInt_t pCbc, const std::string &pName, UInt_t pValue );
		void SetValue( UInt_t pCbc, UInt_t pPage, UInt_t pAddr, UInt_t pValue );
		void SetValue( UInt_t pCbc, const std::string &pName, UInt_t pValue );
	...
	class CbcRegMap : public std::map<UInt_t, FeCbcRegMap >{ 
		...
		public:
			...
			UInt_t GetValue( UInt_t pFE, UInt_t pCbc, UInt_t pPage, UInt_t pAddr )const;
			UInt_t GetValue( UInt_t pFE, UInt_t pCbc, const std::string &pName )const;
			...
			const CbcRegItem *SetValue( UInt_t pFE, UInt_t pCbc, const std::string &pName, UInt_t pValue );
			const CbcRegItem *SetValue( UInt_t pFE, UInt_t pCbc, UInt_t pPage, UInt_t pAddr, UInt_t pValue );
			void ClearRegisters();
